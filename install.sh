...
for _arg in "$@"; do
  case "$_arg" in
    --help|-h)
      ...
      echo "  curl -fsSL https://raw.githubusercontent.com/sweetcheeks72/helios-installer/main/bootstrap.sh | bash"
      echo ""
      echo "Re-run / update:"
      echo "  helios update"
      exit 0
...
HELIOS_RELEASE_URL="https://github.com/sweetcheeks72/helios-installer/releases/latest/download"
...
print_quickstart() {
  ...
  echo -e "    ${DIM}bash ~/helios-installer/install.sh${RESET}  — Update everything"
